...
public class QuestMenuTest {
    ...
    /** Setup for the tests
     * A Questmenu is created and its visibility is set to "false" */
    @Before
    public void setup(){
    ...
    /** Test for the method "showMenu"
     * The method is called and the visibility is set to "true"
     * The test is passed if the visibility is "true" */
    @Test
    ...
    /** Test for the method "hideMenu"
     * The method is called and the visibility is set to "false"
     * The test is passed if the visibility is "false" */
    @Test
    ...
    /** Test for the method "addActiveQuest"
     * The method is called and the screenText is set to the name and status of the quest
    ...
    /** Test for the method "decreaseQuestcounter"
     * The method is called and the questcounter is decreased by 1
     * The test is passed if the questcounter is equal to 0 */
    @Test

...
public class SkillMenu<T extends Actor> extends ScreenController<T> {

    /** Creates a new SkillMenu with a new Spritebatch */
    public SkillMenu() {
        this(new SpriteBatch());
    }

    /** Creates a new SkillMenu with a given Spritebatch */
    public SkillMenu(SpriteBatch batch) {
        super(batch);

...
public class HitboxComponent extends Component {
    ...
    public static final ICollide DEFAULT_COLLIDER = (a, b, c) -> System.out.print("");
    ...
    private transient final Logger hitboxLogger = Logger.getLogger(this.getClass().getName());
